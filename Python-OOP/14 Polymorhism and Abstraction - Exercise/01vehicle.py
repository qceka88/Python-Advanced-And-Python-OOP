...
class Car(Vehicle):
    ...
    def drive(self, distance):
        needed_fuel = distance * (self.fuel_consumption + Car.AIR_CONDITION)
...
class Truck(Vehicle):
    ...
    def drive(self, distance):
        needed_fuel = distance * (self.fuel_consumption + Truck.AIR_CONDITION)
        if needed_fuel <= self.fuel_quantity:
            self.fuel_quantity -= needed_fuel

    def refuel(self, fuel):
        self.fuel_quantity += fuel * Truck.TANK_LOSSES
